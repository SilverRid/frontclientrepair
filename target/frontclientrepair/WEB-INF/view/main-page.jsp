...
<body>
<div class="wrapper">
    <div class="box1"> <img src="<c:url value="/resources/images/logo_ru.png"/>" alt=""/> </div>
    ...
    <div class="box3">
        ...
        $m_oConn — это переменная-член тестового класса, которая представляет собой некоторую обертку вокруг PDO. А если быть точным, то это экземпляр класса PHPUnit_Extensions_Database_DB_DefaultDatabaseC
...
<img src="<c:url value="/resources/images/logo_ru.png"/>" alt=""/>
<p>Привет</p>
</body>
</html>
